...
class BlogRepo extends Repository
{
    ...
    protected $repo_fields 	= ['id', 'user_id', 'category_id', 'image', 'images', 'status', 'comment_status', 'type', 'options', 'title', 'slug', 'description', 'content', 'meta_keywords', 'meta_description', 'created_at', 'updated_at', 'deleted_at'];
